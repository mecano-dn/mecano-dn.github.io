...
monumental collection of 37 books, the NH is populated by multiple people who are mentioned in very
...
the Greek commentaries on Aristotle (most of which were written by Platonists), thus contributing to RO1.
Combining the statistics of the texts and passages quoted in the largest philosophical corpus extant from
antiquity (Commentaria in Aristotelem graeca or CAG) with a qualitative and conceptual analysis of
selected passages, this project has the following specific objectives: (1) to analyse the principles of inclusion
...
Pliny the Elder, and Vitruvius, and their reception and reuse in Early modern works. The specific
...
diverse Hellenistic pulse theories. Addressing RO2 (understanding the dynamics of loss in textual
transmission), this project’s specific objectives are (1) to map and explain the canon of Hellenistic ideas
...
and preserved through quotations and paraphrases in later sources (contributing to RO2). Classical
...
authors who are now lost. The specific objectives of this project are (1) to discover why and how authors
...
Africa. Addressing RO2 (understanding dynamics of inclusion in and exclusion from the canon), this
project will recover, describe and analyse the sermons of forgotten late-antique preachers, preserved
through association with Augustine. Specific objectives of this project are: (1) to create a dataset of
...
and petitions). The specific objectives of this project, contributing to RO3, are: (1) to study a syntactic
...
presence of ancient sources and their use by late medieval thinkers. The specific objectives of this PhD
...
project are therefore (1) to build a large, multi-disciplinary corpus of scientific journals from JSTOR. Next
we will reuse existing computational workflows from the Trismegistos project (TM) (2) to detect ancient
canonic references in this corpus. The main analytical objective will be to (3) to analyse the extracted
...
analyses, which allows us (4) to put the canonical references in context and better understand their usage.
With this project we develop a novel approach called ‘contextual scientometrics’. This project addresses
...
discourse (RO4), and takes it to a new level by setting the following specific objectives: (1) to use reference
...
cultural change and ancient canonicity (RO4).
